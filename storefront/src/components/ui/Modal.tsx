...
export const getModalClassNames = ({
  ...
  return twJoin(
    "bg-white max-sm:px-4 p-6 rounded-lg max-h-full overflow-y-scroll max-w-154 w-full shadow-modal data-[entering]:animate-in data-[entering]:ease-out data-[entering]:duration-200 data-[exiting]:animate-out data-[exiting]:ease-in data-[exiting]:duration-100",
