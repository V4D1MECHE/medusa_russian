...
export default function TermsOfUsePage() {
  return (
    <Layout className="pt-30 pb-20 md:pt-47 md:pb-32">
      ...
      >
        <p>
          Welcome to MiLi. These Terms of Use govern your access to and
        ...
        <p>
          To the maximum extent permitted by law, MiLi and its
        ...
        <p>
          You agree to indemnify, defend, and hold harmless MiLi and its
